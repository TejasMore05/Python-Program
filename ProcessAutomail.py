# Automation script which accept time interval from user and create log file in that Marvellous directory which contains information of all running process.After creating the log file send that log file thorough mail.
...
def MailSender(filename,time): 
    try:
        fromaddr = "thetejasmoregmail.com" 
        toaddr = "tmore05032002@ymail.com"
        ...
        p.add_header('Content-Disposition',"attachment; filename= %s" % flename)
        ...
        s.login(fromaddr,"thetejasmore@gmail.com")
